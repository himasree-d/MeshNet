var capacitorNearbyConnections = (function (exports, core) {
    'use strict';
     ...
     */
    const MAX_BYTES_DATA_SIZE = 1047552;
    /**
    ...
    (function (Status) {
         ...
         */
        Status["ALREADY_CONNECTED_TO_ENDPOINT"] = "ALREADY_CONNECTED_TO_ENDPOINT";
        /**
         * The remote endpoint rejected the connection request.
         */
        Status["CONNECTION_REJECTED"] = "CONNECTION_REJECTED";
        /**
         * The remote endpoint is not connected; messages cannot be sent to it.
         */
        Status["NOT_CONNECTED_TO_ENDPOINT"] = "NOT_CONNECTED_TO_ENDPOINT";
        /**
         * There was an error trying to use the phone's Bluetooth/WiFi/NFC capabilities.
         */
        Status["RADIO_ERROR"] = "RADIO_ERROR";
        /**
         ...
         */
        Status["ALREADY_HAVE_ACTIVE_STRATEGY"] = "ALREADY_HAVE_ACTIVE_STRATEGY";
        /**
         * The app called an API method out of order (i.e. another method is expected to be called first).
         */
        Status["OUT_OF_ORDER_API_CALL"] = "OUT_OF_ORDER_API_CALL";
        Status["UNSUPPORTED_PAYLOAD_TYPE_FOR_STRATEGY"] = "UNSUPPORTED_PAYLOAD_TYPE_FOR_STRATEGY";
        /**
         ...
         */
        Status["ENDPOINT_UNKNOWN"] = "ENDPOINT_UNKNOWN";
        /**
         * An attempt to read from/write to a connected remote endpoint failed.
         */
        Status["ENDPOINT_IO_ERROR"] = "ENDPOINT_IO_ERROR";
        /**
         * An attempt to read/write data for a `Payload` of type `FILE` or `STREAM` failed.
         */
        Status["PAYLOAD_IO_ERROR"] = "PAYLOAD_IO_ERROR";
        Status["PAYLOAD_UNKNOWN"] = "PAYLOAD_UNKNOWN";
        Status["ALREADY_LISTENING"] = "ALREADY_LISTENING";
         ...
         */
        Status["ALREADY_IN_USE"] = "ALREADY_IN_USE";
     ...
     */
    exports.PayloadTransferUpdateStatus = void 0;
    (function (PayloadTransferUpdateStatus) {
        /**
         * The remote endpoint has successfully received the full transfer.
         *
         * @since 1.0.0
         */
        PayloadTransferUpdateStatus["SUCCESS"] = "success";
        /**
         * Either the local or remote endpoint has canceled the transfer.
         *
         * @since 1.0.0
         */
        PayloadTransferUpdateStatus["CANCELED"] = "canceled";
        /**
         * The remote endpoint failed to receive the transfer.
         *
         * @since 1.0.0
         */
        PayloadTransferUpdateStatus["FAILURE"] = "failure";
        /**
         * The the transfer is currently in progress with an associated progress value.
         *
         * @since 1.0.0
         */
        PayloadTransferUpdateStatus["IN_PROGRESS"] = "inProgress";
    })(exports.PayloadTransferUpdateStatus || (exports.PayloadTransferUpdateStatus = {}));
    /**
    ...
    (function (Strategy) {
         ...
         */
        Strategy["POINT_TO_POINT"] = "pointToPoint";
    ...
    (function (BluetoothState) {
         ...
         * @since 1.0.0
         */
        BluetoothState["POWERED_OFF"] = "poweredOff";
        /**
         * A state that indicates Bluetooth is currently powered on and available to use.
         *
         * @since 1.0.0
         */
        BluetoothState["POWERED_ON"] = "poweredOn";
    })(exports.BluetoothState || (exports.BluetoothState = {}));

    const NearbyConnections = core.registerPlugin('NearbyConnections', {
        web: () => Promise.resolve().then(function () { return web; }).then((m) => new m.NearbyConnectionsWeb()),
    });

    class NearbyConnectionsWeb extends core.WebPlugin {
        ...
        async sendPayload(options) {
            console.info('sendPayload', options);
            // throw this.unimplemented('Method not implemented.');
            return {
                payloadID: -1,
                payloadType: exports.PayloadType.BYTES,
                status: exports.PayloadTransferUpdateStatus.SUCCESS,
            };
        }
        async cancelPayload(options) {
    ...
    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        NearbyConnectionsWeb: NearbyConnectionsWeb
    });

    exports.MAX_BYTES_DATA_SIZE = MAX_BYTES_DATA_SIZE;
    exports.NearbyConnections = NearbyConnections;
