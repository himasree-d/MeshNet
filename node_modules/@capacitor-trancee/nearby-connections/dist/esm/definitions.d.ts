...
export declare type NearbyConnectionPermissionType = 'wifiNearby' | 'wifiState' | 'bluetoothNearby' | 'bluetoothLegacy' | 'location' | 'locationCoarse';
 ...
 */
export declare const MAX_BYTES_DATA_SIZE = 1047552;
/**
 ...
 * @since 1.0.0
 */
export declare type PayloadID = number;
/**
...
export declare enum Status {
     ...
     */
    ALREADY_CONNECTED_TO_ENDPOINT = "ALREADY_CONNECTED_TO_ENDPOINT",
    /**
     ...
     */
    NOT_CONNECTED_TO_ENDPOINT = "NOT_CONNECTED_TO_ENDPOINT",
    /**
     ...
     */
    ALREADY_HAVE_ACTIVE_STRATEGY = "ALREADY_HAVE_ACTIVE_STRATEGY",
    /**
     * The app called an API method out of order (i.e. another method is expected to be called first).
     */
    OUT_OF_ORDER_API_CALL = "OUT_OF_ORDER_API_CALL",
     ...
     */
    ENDPOINT_IO_ERROR = "ENDPOINT_IO_ERROR",
    /**
 ...
 * Called when a remote endpoint is discovered.
 */
export declare type EndpointFoundCallback = (_: Endpoint) => void;
/**
 * Called when a remote endpoint is no longer discoverable.
 */
export declare type EndpointLostCallback = (_: Endpoint) => void;
/**
 * A basic encrypted channel has been created between you and the endpoint.
 * Both sides are now asked if they wish to accept or reject the connection before any data can be sent over this channel.
 */
export declare type EndpointInitiatedCallback = (_: Endpoint & ConnectionInfo) => void;
/**
 * Called after both sides have accepted the connection.
 * Both sides may now send Payloads to each other.
 */
export declare type EndpointConnectedCallback = (_: Endpoint) => void;
/**
 * Called when either side rejected the connection.
 * Payloads can not be exchaged.
 */
export declare type EndpointRejectedCallback = (_: Endpoint) => void;
export declare type EndpointFailedCallback = (_: Endpoint & Status) => void;
/**
 * Called when a remote endpoint is disconnected or has become unreachable.
 * At this point service (re-)discovery may start again.
 */
export declare type EndpointDisconnectedCallback = (_: Endpoint) => void;
/**
 * Called when a connection is established or if the connection quality improves to a higher connection bandwidth.
 */
export declare type EndpointBandwidthChangedCallback = (_: Endpoint & BandwidthInfo) => void;
/**
 ...
 */
export declare type PayloadReceivedCallback = (_: Endpoint & Payload) => void;
/**
 * Called with progress information about an active payload transfer, either incoming or outgoing.
 */
export declare type PayloadTransferUpdateCallback = (_: Endpoint & PayloadTransferUpdate) => void;
/**
 ...
 */
export declare enum PayloadTransferUpdateStatus {
    /**
